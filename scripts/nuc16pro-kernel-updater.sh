...
Type=oneshot
RemainAfterExit=yes
# ACPI platform_profile=performance: unified fan/thermal/turbo control on this
# board (firmware/EC owns the actual fan curve; the OS only picks the profile).
# performance holds max turbo residency. Runtime-switchable to balanced/low-power.
